<template>
  <div class="whole-SMS">
    ...
    <m-table v-if="tableData.length > 0" :tableData="tableData" :columns="tableColumns" @pageChange="pageChange" :page="pageInfo" :stripe="true" :border="false" layout="total, prev, pager, next, jumper">
      <div slot="btn" slot-scope="{row}">
        <div>
          ...
          <!-- 通过 -->
          <el-tooltip class="item" effect="light" content="点击通过" placement="top">
            <el-button class="btn-img" type="text" @click="adoptOrRefuseOrdel('adopt', row)"><img src="@/assets/marketSMS/tongguo.png" alt="" /></el-button>
          </el-tooltip>
          <!-- 拒绝 -->
          <el-tooltip class="item" effect="light" content="点击拒绝" placement="top">
