<template>
  <div class="RelationSign">
    ...
    <div class="list">
      <el-button type="primary" @click="addRelSign('add')" class="moreList">关联更多签名</el-button>
    </div>
        ...
        <div class="card">
          ...
          <div class="name-date">
            ...
            <p>
              ...
              <el-tooltip v-if="item.configSignatureCode !== null" class="item" effect="light" :content="item.configSignatureCode" placement="top">
                <span class="name-label-span">{{ item.configSignatureCode }}</span>
              </el-tooltip>
              <span v-else class="name-label-span">{{ item.configSignatureCode }}</span>
            </p>
          </div>
        </div>
      </el-card>
