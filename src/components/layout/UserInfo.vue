<template>
	<div class="user-info">
		<div class="user-content">
			...
			<img src="@/assets/Logout/avatar.png" alt="用户头像" />
		...
		<!-- 退出动作 -->
    <el-dialog :visible.sync="centerDialogVisible" width="322px" center :show-close="false" top="22vh" :modal-append-to-body="false" class="dia-logout dia-form">
      <span class="diaLog-span" style="text-align:center;">确认退出系统?</span>
      <span slot="footer" class="dialog-footer">
        <el-button @click="logoutDia" class="cancelSumbitBtn" style="margin-right: 20px;">取 消</el-button>
        <el-button type="primary" @click="clearToken" class="sumbitBtn">确 定</el-button>
      </span>
    </el-dialog>
	</div>
</template>
